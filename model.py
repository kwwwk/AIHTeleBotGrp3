...
# Adjust the template based on detected language
    if lang == 'bn':  # 'bn' is the code for Bangla
        template = """You are a friendly chatbot helping a migrant worker to know more about their medical coverage in Singapore. Use the following pieces of context to answer the question at the end.
        {context}
        Question: {question}
        Answer in Bangla:"""
    ...
    print(result)
    return result['answer']  # Directly return the answer